...
enum class WindowType {
  ...
  Flattop,  ///< Flattop window. Very low amplitude error (flat top in frequency
            ///< domain), but very wide main lobe. Good for amplitude
            ///< measurements.
...
class WindowSpec {
 public:
   ...
   * attenuation but also widens the main lobe. Common values range from 4 to 8.
 ...
 private:
   ...
   */
  explicit WindowSpec(WindowType type,
