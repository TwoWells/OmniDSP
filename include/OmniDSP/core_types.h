...
namespace OmniDSP {
  ...
  enum class Status {
    ...
    InvalidOperation
    = 6,                 ///< Operation attempted in an invalid state (e.g.,
   ...
   * standard way to return either a value or a Status error code. Requires
   * C++23. Example Usage: OmniExpected<int> result = my_function(); if (result)
