...
#include "fft_lib.h"      // Include the library header
#include <iostream>
#include <vector>
#include <complex>
...
int main() {
    ...
    using Real = double;
    const auto CURRENT_PRECISION = CrossPlatformFFT::Precision::DOUBLE; // Set precision based on types used
    ...
    try {
        ...
        CrossPlatformFFT::FFTPlan<Real> forward_plan_c2c(N, CURRENT_PRECISION, CrossPlatformFFT::Direction::FORWARD, CrossPlatformFFT::Domain::COMPLEX);
        CrossPlatformFFT::FFTPlan<Real> inverse_plan_c2c(N, CURRENT_PRECISION, CrossPlatformFFT::Direction::INVERSE, CrossPlatformFFT::Domain::COMPLEX);
        ...
        CrossPlatformFFT::fft(input_signal_c2c, spectrum_conv_c2c); // Forward FFT
        CrossPlatformFFT::ifft(spectrum_conv_c2c, reconstructed_conv_c2c); // Inverse FFT
        ...
        // --- Method 3: In-place Transform (C2C Example) ---
         ...
         // *** CORRECTED CONSTRUCTOR CALLS ***
         CrossPlatformFFT::FFTPlan<Real> inplace_plan_fwd_c2c(N, CURRENT_PRECISION, CrossPlatformFFT::Direction::FORWARD, CrossPlatformFFT::Domain::COMPLEX);
         ...
         // *** CORRECTED CONSTRUCTOR CALLS ***
         CrossPlatformFFT::FFTPlan<Real> inplace_plan_inv_c2c(N, CURRENT_PRECISION, CrossPlatformFFT::Direction::INVERSE, CrossPlatformFFT::Domain::COMPLEX);
        ...
        CrossPlatformFFT::fft_r2c(input_signal_real, r2c_spectrum);
        ...
        CrossPlatformFFT::ifft_c2r(r2c_spectrum, c2r_reconstructed);
