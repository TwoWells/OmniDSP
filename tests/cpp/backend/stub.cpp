 ...
 * @brief Unit tests specifically for the Stub backend convolution/correlation behavior.
 */
...
// Test fixture (can inherit if common setup is needed, but maybe not necessary here)
class BackendConvStubTest : public ::testing::Test {};

// Test specifically if stub backend throws (this is the test moved from the main file)
