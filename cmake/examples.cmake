...
# ====================
# Includes example subdirectories based on the build configuration. Currently, it only adds the C++
# examples subdirectory (examples/cpp) if Python bindings are *not* being built. Python examples
# (notebooks) are handled by installation rules.
#
...
if(OMNIDSP_BUILD_PYTHON_BINDINGS)
  # Python examples (notebooks) are handled during installation (installation.cmake) No subdirectory
  # needs to be added here for them.
  message(STATUS "  Python examples (notebooks) are handled by installation rules.")
else()
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/examples/cpp/CMakeLists.txt")
    message(STATUS "    Found examples/cpp/CMakeLists.txt, adding subdirectory.")
    ...
    # Note: The examples/cpp/CMakeLists.txt will need to link its executables against the main
    # omnidsp library target (e.g., target_link_libraries(my_example PRIVATE OmniDSP::omnidsp))
  else()
    message(
      STATUS
