# cmake/testing.cmake
# ===================
# Enables CTest support for the project and includes test subdirectories
# (tests/python or tests/cpp) based on the OMNIDSP_BUILD_PYTHON_BINDINGS option.
#
...
if(OMNIDSP_BUILD_PYTHON_BINDINGS)
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/python/CMakeLists.txt")
    message(
      STATUS "    Found tests/python/CMakeLists.txt, adding subdirectory.")
  ...
  if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/tests/cpp/CMakeLists.txt")
    ...
    # Note: The C++ tests CMakeLists.txt will need to find GTest itself using
    # find_package(GTest REQUIRED) and link targets appropriately. The
    # find_package(GTest) call was moved to dependencies.cmake, but the targets
    # (GTest::gtest, GTest::gtest_main) need linking in tests/cpp.
  else()
    message(
      STATUS
