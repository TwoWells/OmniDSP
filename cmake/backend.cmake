...
# files from the cmake/backend/ directory. Each included file is expected to set
# backend-specific variables (sources, includes, libs, etc.) in the
# PARENT_SCOPE. This script aggregates these settings into common variables.
#
# Includes: - cmake/backend/default.cmake - cmake/backend/accelerate.cmake -
# cmake/backend/onemkl.cmake
#
# Variables Set (Aggregated): - OMNIDSP_ALL_BACKEND_SOURCES (LIST): All source
# files for enabled backends. - OMNIDSP_ALL_BACKEND_INCLUDE_DIRS (LIST): Private
# include dirs for enabled backends. - OMNIDSP_ALL_BACKEND_COMPILE_DEFS (LIST):
# Compile definitions for enabled backends. - OMNIDSP_ALL_BACKEND_LINK_LIBS
# (LIST): Libraries to link for enabled backends. -
# OMNIDSP_ALL_BACKEND_LINK_DIRS (LIST): Link directories for enabled backends. -
# OMNIDSP_HAS_ACCELERATE (BOOL): True if Accelerate backend is available and
# configured. - OMNIDSP_HAS_ONEMKL (BOOL): True if oneMKL backend is available
# and configured.
# ===================
...
set(OMNIDSP_ALL_BACKEND_SOURCES "") # List of all source files for enabled
                                    # backends
set(OMNIDSP_ALL_BACKEND_INCLUDE_DIRS "") # List of private include dirs for
                                         # enabled backends
set(OMNIDSP_ALL_BACKEND_COMPILE_DEFS "") # List of compile definitions for
                                         # enabled backends
set(OMNIDSP_ALL_BACKEND_LINK_LIBS "") # List of libraries to link for enabled
                                      # backends
set(OMNIDSP_ALL_BACKEND_LINK_DIRS "") # List of link directories for enabled
                                      # backends
...
if(OMNIDSP_HAS_ACCELERATE)
  ...
  list(APPEND OMNIDSP_ALL_BACKEND_INCLUDE_DIRS
       ${ACCELERATE_BACKEND_INCLUDE_DIR})
...
if(OMNIDSP_HAS_ONEMKL)
  ...
  list(APPEND OMNIDSP_ALL_BACKEND_INCLUDE_DIRS ${ONEMKL_INCLUDE_DIRS}
  )# Add MKL/IPP includes found by find_package (if any)
  list(APPEND OMNIDSP_ALL_BACKEND_LINK_DIRS ${ONEMKL_LINK_DIRS}) # Add link dirs
                                                                 # (likely empty
                                                                 # now)
endif()
...
message(STATUS "  Aggregate Backend Sources: ${OMNIDSP_ALL_BACKEND_SOURCES}")
message(
  STATUS "  Aggregate Backend Include Dirs: ${OMNIDSP_ALL_BACKEND_INCLUDE_DIRS}"
)
message(
  STATUS "  Aggregate Backend Compile Defs: ${OMNIDSP_ALL_BACKEND_COMPILE_DEFS}"
)
message(
  STATUS "  Aggregate Backend Link Libs: ${OMNIDSP_ALL_BACKEND_LINK_LIBS}")
message(
  STATUS "  Aggregate Backend Link Dirs: ${OMNIDSP_ALL_BACKEND_LINK_DIRS}")
