...
// Include headers for all Design/Coef/Params types used in method signatures
#include "OmniDSP/coefs/fir_filter.hpp"
#include "OmniDSP/coefs/iir_filter.hpp"
#include "OmniDSP/core_types.hpp"  // For get_backend_name, get_operation_category_name
...
namespace OmniDSP::Dispatcher {
  ...
  {
    // The "type" of the dispatcher is considered its own unique type.
    return BackendType::Dispatcher;
  }
  ...
  Backend::create_cqt_processor_impl_f32(const Design::CQT& design) const
  {
    return select_backend(OperationCategory::CQT)
        ->create_cqt_processor_impl_f32(design);
  }

  [[nodiscard]] OmniExpected<std::unique_ptr<Abstract::CQTProcessorImpl<F64>>>
  Backend::create_cqt_processor_impl_f64(const Design::CQT& design) const
  {
    return select_backend(OperationCategory::CQT)
        ->create_cqt_processor_impl_f64(design);
  }

  [[nodiscard]] OmniExpected<
      std::unique_ptr<Abstract::ResampleProcessorImpl<F32>>>
  Backend::create_resample_processor_impl_f32(
      const Design::Resample& design) const
  {
    return select_backend(OperationCategory::Resample)
        ->create_resample_processor_impl_f32(design);
  }
  ...
  {
    return select_backend(OperationCategory::Resample)
        ->create_resample_processor_impl_f64(design);
  }

  // Updated ConvolutionPlanImpl Factories
  [[nodiscard]] OmniExpected<
  ...
  {
    return select_backend(OperationCategory::Convolution)
        ->create_convolution_plan_impl_f32(params, kernel_coeffs);
  }
  ...
  {
    return select_backend(OperationCategory::Convolution)
        ->create_convolution_plan_impl_f64(params, kernel_coeffs);
  }
  ...
  {
    return select_backend(OperationCategory::Convolution)
        ->create_convolution_plan_impl_c32(params, kernel_coeffs);
  }
  ...
  {
    return select_backend(OperationCategory::Convolution)
        ->create_convolution_plan_impl_c64(params, kernel_coeffs);
  }

  // Updated CorrelationPlanImpl Factories
  [[nodiscard]] OmniExpected<
  ...
  {
    return select_backend(OperationCategory::Correlation)
        ->create_correlation_plan_impl_f32(params, template_coeffs);
  }
  ...
  {
    return select_backend(OperationCategory::Correlation)
        ->create_correlation_plan_impl_f64(params, template_coeffs);
  }
  ...
  {
    return select_backend(OperationCategory::Correlation)
        ->create_correlation_plan_impl_c32(params, template_coeffs);
  }
  ...
  {
    return select_backend(OperationCategory::Correlation)
        ->create_correlation_plan_impl_c64(params, template_coeffs);
  }

  // Updated FIRFilterProcessorImpl Factories
  [[nodiscard]] OmniExpected<
  ...
  // IIRFilterProcessorImpl Factories
  [[nodiscard]] OmniExpected<
  ...
  Backend::design_fir_filter_f32(const Design::FIRFilter& design) const
  {
    return select_backend(OperationCategory::FilterDesign)
        ->design_fir_filter_f32(design);
  }

  [[nodiscard]] OmniExpected<Coefs::FIRFilter<F64>>
  Backend::design_fir_filter_f64(const Design::FIRFilter& design) const
  {
    return select_backend(OperationCategory::FilterDesign)
        ->design_fir_filter_f64(design);
  }
  ...
  Backend::design_iir_filter_f32(const Design::IIRFilter& design) const
  {
    return select_backend(OperationCategory::FilterDesign)
        ->design_iir_filter_f32(design);
  }

  [[nodiscard]] OmniExpected<Coefs::IIRFilterSOS>
  Backend::design_iir_filter_f64(const Design::IIRFilter& design) const
  {
    return select_backend(OperationCategory::FilterDesign)
        ->design_iir_filter_f64(design);
  }
