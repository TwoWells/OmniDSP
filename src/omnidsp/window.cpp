...
/**
 * @brief Applies the Hann window by getting coefficients from backend and
 * multiplying.
 */
template <typename T>
std::vector<T> Window::hann(const std::vector<T>& input) {
  if (input.empty()) {
    ...
    throw std::invalid_argument(
        "Input vector cannot be empty for Window::hann.");
...
/**
 * @brief Applies the Hamming window by getting coefficients from backend and
 * multiplying.
 */
template <typename T>
std::vector<T> Window::hamming(const std::vector<T>& input) {
  if (input.empty()) {
    throw std::invalid_argument(
        "Input vector cannot be empty for Window::hamming.");
  }
  size_t length = input.size();
...
/**
 * @brief Applies the Kaiser window by getting coefficients from backend and
 * multiplying.
 */
template <typename T>
std::vector<T> Window::kaiser(const std::vector<T>& input, T beta) {
  if (input.empty()) {
    throw std::invalid_argument(
        "Input vector cannot be empty for Window::kaiser.");
  }
  if (beta < 0) {
...
/**
 * @brief Applies the Flattop window by getting coefficients from backend and
 * multiplying.
 */
template <typename T>
std::vector<T> Window::flattop(const std::vector<T>& input) {
  if (input.empty()) {
    throw std::invalid_argument(
        "Input vector cannot be empty for Window::flattop.");
  }
  size_t length = input.size();
...
template std::vector<float> Window::hann<float>(
    const std::vector<float>& input);
template std::vector<double> Window::hann<double>(
    const std::vector<double>& input);

template std::vector<float> Window::hamming<float>(
    const std::vector<float>& input);
template std::vector<double> Window::hamming<double>(
    const std::vector<double>& input);

template std::vector<float> Window::kaiser<float>(
    const std::vector<float>& input, float beta);
template std::vector<double> Window::kaiser<double>(
    const std::vector<double>& input, double beta);

template std::vector<float> Window::flattop<float>(
    const std::vector<float>& input);
template std::vector<double> Window::flattop<double>(
    const std::vector<double>& input);
